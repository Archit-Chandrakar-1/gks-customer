...
{/* 
        ...
        <div className="widget-box-2 mb-20">
          <h5 className="title">Your Price</h5>
          ...
          <div className="box grid-3 gap-30">
            ...
            <fieldset className="box-fieldset">
              <label htmlFor="garages">
                {" "}
                Super Built-Up Area (for flats/apartments)<span>*</span>{" "}
              </label>
              <input type="text" className="form-control" />
            </fieldset>
        ...
        <div className="widget-box-2 mb-20">
          <h5 className="title">Amenities<span>*</span></h5>
            ...
            <div className="list-amenities">
              <fieldset className="amenities-item">
                <input
                  ...
                  id="power-backup"
                />
                <label htmlFor="power-backup" className="text-cb-amenities">
                  Power Backup
                </label>
              </fieldset>
              <fieldset className="amenities-item">
                <input
                  ...
                  id="security"
                />
                <label htmlFor="security" className="text-cb-amenities">
                  24x7 Security
                </label>
              </fieldset>
              <fieldset className="amenities-item">
                <input
                  ...
                  id="balcony"
                />
                <label htmlFor="balcony" className="text-cb-amenities">
                  Balcony
                </label>
              </fieldset>
              <fieldset className="amenities-item">
                <input
                  ...
                  id="pre-school"
                />
                <label htmlFor="pre-school" className="text-cb-amenities">
                  Pre-School
                </label>
              </fieldset>
              <fieldset className="amenities-item">
                <input
                  ...
                  id="view-landmark"
                />
                <label htmlFor="view-landmark" className="text-cb-amenities">
                  View of Landmark
                </label>
              </fieldset>
              <fieldset className="amenities-item">
                <input
                  ...
                  id="security-staff"
                />
                <label htmlFor="security-staff" className="text-cb-amenities">
                  Security Staff
                </label>
              </fieldset>
            </div>
...
{/* 
      ...
      <div className="footer-dashboard">
        <p>Copyright © 2025 Gharkasathi</p>
      </div>
    </div>
  );
}
