...
export default function Header1({
  ...
  return ( 
    ...
    >
      <style jsx global>{`
        .main-header.header-fixed.fixed-header, header#header, header#header.is-fixed {
            ...
            <div className="inner-header">
              ...
              <div className="inner-header-right header-account">
                <a
                  ...
                  className="tf-btn btn-line btn-login small-anchor"
                >
                  <svg
                    width={20}
                    height={20}
                ...
                <div className="flat-bt-top">
                  <Link className="tf-btn primary small-anchor" href={`/add-property`}>
                    <svg
                      width={21}
                      height={20}
                      viewBox="0 0 21 20"
        ...
        <nav className="menu-box">
          ...
          <div className="bottom-canvas">
            <div className="login-box flex align-center">
              <a href="#modalLogin" data-bs-toggle="modal" className="small-anchor">
                Login
              </a>
              <span className="small-anchor">/</span>
              <a href="#modalRegister" data-bs-toggle="modal" className="small-anchor">
                Register
              </a>
            </div>
