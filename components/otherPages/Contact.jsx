                ...
                <ul>
                  <li className="box">
                    ...
                    <p className="text-variant-1">
                      4034 4th Floor, Currency Tower Raipur C.G <br />
                      India
                    </p>
                  </li>
                  <li className="box">
                    ...
                    <p className="text-variant-1">
                      ...
                      +91 9202600601  <br /> +91 7477244487 <br />
                  ...
                  <li className="box">
                    ...
                    <ul className="box-social">
                      ...
                      <li>
                        <a href="https://www.instagram.com/gharkasathi?igsh=ZmJ1NTl5d2RsYjV1" className="item">
                          <svg
                            width={18}
                            height={18}
                            viewBox="0 0 18 18"
                      ...
                      <li>
                        <a href="https://youtube.com/@gharkasathi?si=x0eul3001IksXcWp" className="item">
                          <svg
                            width={20}
                            height={14}
                            viewBox="0 0 20 14"
